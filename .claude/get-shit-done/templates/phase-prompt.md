...
<!-- For checkpoint task examples and patterns, see @D:/E-commerce/bazzar-mart/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/E-commerce/bazzar-mart/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/E-commerce/bazzar-mart/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/E-commerce/bazzar-mart/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
