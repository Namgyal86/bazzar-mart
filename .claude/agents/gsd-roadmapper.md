...
Reference full template: `D:/E-commerce/bazzar-mart/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/E-commerce/bazzar-mart/.claude/get-shit-done/templates/state.md`.
