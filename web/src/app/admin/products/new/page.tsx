...
export default function AdminNewProductPage() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      images.filter(Boolean).forEach(url => formData.append('images', url));
    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Add a product directly to the platform as admin</p>
        </div>
      </div>
        ...
        <div className={sectionCls} style={sectionStyle}>
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              placeholder="Describe the product — features, specifications, what's in the box..."
